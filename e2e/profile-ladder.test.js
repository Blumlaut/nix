...
// Same catalog as src/services/progression.js: [tier, level, name, reward,
// value]. Tiers 1-16 sit on their own level, the milestone tiers above them
// jump ahead so the track covers the level-500 cap.
const TIERS = [
  [1, 1, 'Rookie', 'title', 'Rookie'],
  [2, 2, 'Blue Border', 'border', 'blue'],
  [3, 3, 'Nix Apprentice', 'title', 'Nix Apprentice'],
  [4, 4, 'Purple Border', 'border', 'purple'],
  [5, 5, 'Nix Adept', 'title', 'Nix Adept'],
  [6, 6, 'Gold Border', 'border', 'gold'],
  [7, 7, 'Nix Master', 'title', 'Nix Master'],
  [8, 8, 'Rainbow Border', 'border', 'rainbow'],
  [9, 9, 'Nix Grandmaster', 'title', 'Nix Grandmaster'],
  [10, 10, 'Nix Legend', 'badge', 'legend'],
  [11, 11, 'Nix Overlord', 'title', 'Nix Overlord'],
  [12, 12, 'Emerald Border', 'border', 'emerald'],
  [13, 13, 'Nix Sovereign', 'title', 'Nix Sovereign'],
  [14, 14, 'Platinum Border', 'border', 'platinum'],
  [15, 15, 'Nix Immortal', 'title', 'Nix Immortal'],
  [16, 16, 'Nix Mythic', 'badge', 'mythic'],
  [17, 20, 'Nix Warlord', 'title', 'Nix Warlord'],
  [18, 25, 'Ruby Border', 'border', 'ruby'],
  [19, 30, 'Nix Champion', 'title', 'Nix Champion'],
  [20, 40, 'Nix Comet', 'badge', 'celestial'],
  [21, 50, 'Sapphire Border', 'border', 'sapphire'],
  [22, 75, 'Nix Paragon', 'title', 'Nix Paragon'],
  [23, 100, 'Jade Border', 'border', 'jade'],
  [24, 150, 'Nix Eternal', 'badge', 'eternal'],
  [25, 200, 'Nix Ascendant', 'title', 'Nix Ascendant'],
  [26, 250, 'Aurora Border', 'border', 'aurora'],
  [27, 300, 'Nix Archon', 'title', 'Nix Archon'],
  [28, 350, 'Nix Phoenix', 'badge', 'phoenix'],
  [29, 400, 'Nix Primordial', 'title', 'Nix Primordial'],
  [30, 450, 'Prismatic Border', 'border', 'prismatic'],
  [31, 500, 'Nix Deity', 'badge', 'deity'],
];
...
function profile() {
  ...
  return {
    ...
    battlepass: {
      ...
      maxLevel: MAX_LEVEL,
      levelProgress: levelXp / XP_PER_LEVEL,
      tiers: TIERS.map(([tier, lvl, name, reward, value]) => ({
        tier,
        name,
