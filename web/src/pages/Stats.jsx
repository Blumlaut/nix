            ...
            {locs?.cells.length ? (
              <>
                ...
                <p className="loc-note">
                  ...
                  click one to see who nixed whom. Scroll while the pointer is on the map to zoom
                  in and out. Pins closer together than a pin is wide merge into a single pin
                  while zoomed out — click it, or zoom in, to split them apart again. A pin is
                  drawn dashed while it is only known to a roughly 11 km area, and solid once
                  {solidRule} land within the same about-a-kilometre cell. Individual positions
                  are never shown.
                </p>
              </>
            ) : (
